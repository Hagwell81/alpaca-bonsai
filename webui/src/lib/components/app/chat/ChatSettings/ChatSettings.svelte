<script lang="ts">
	...
	const settingSections: Array<{
		...
		},
		{
			...
			fields: [
				{
					key: SETTINGS_KEYS.VOICE_STT_ENABLED,
					label: 'Enable speech-to-text (microphone)',
					type: SettingsFieldType.CHECKBOX
				},
				{
					key: SETTINGS_KEYS.VOICE_TTS_ENABLED,
					label: 'Enable text-to-speech (speaker icons)',
					type: SettingsFieldType.CHECKBOX
				}
			]
		},
		...
		},
		{
			...
			fields: [
				...
				{
					key: SETTINGS_KEYS.DRY_SEQUENCE_BREAKERS,
		...
		},
		{
			...
			fields: [
				{
					key: SETTINGS_KEYS.SEED,
					label: 'Seed',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.MIROSTAT,
					label: 'Mirostat mode',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.MIROSTAT_TAU,
					label: 'Mirostat tau',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.MIROSTAT_ETA,
					label: 'Mirostat eta',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.N_KEEP,
					label: 'N keep',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.N_DISCARD,
					label: 'N discard',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.IGNORE_EOS,
					label: 'Ignore EOS',
					type: SettingsFieldType.CHECKBOX
				},
				{
					key: SETTINGS_KEYS.GRAMMAR,
					label: 'Grammar',
					type: SettingsFieldType.TEXTAREA
				},
				{
					key: SETTINGS_KEYS.GRAMMAR_LAZY,
					label: 'Grammar lazy',
					type: SettingsFieldType.CHECKBOX
				},
				{
					key: SETTINGS_KEYS.STOP,
					label: 'Stop sequences',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.LOGIT_BIAS,
					label: 'Logit bias (JSON)',
					type: SettingsFieldType.TEXTAREA
				},
				{
					key: SETTINGS_KEYS.N_PROBS,
					label: 'N probs',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.MIN_KEEP,
					label: 'Min keep',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.TOP_N_SIGMA,
					label: 'Top N sigma',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.POST_SAMPLING_PROBS,
					label: 'Post sampling probs',
					type: SettingsFieldType.CHECKBOX
				},
				{
					key: SETTINGS_KEYS.CHAT_FORMAT,
					label: 'Chat format',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.SPECULATIVE_N_MAX,
					label: 'Speculative n_max',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.SPECULATIVE_N_MIN,
					label: 'Speculative n_min',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.SPECULATIVE_P_MIN,
					label: 'Speculative p_min',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.LORA,
					label: 'LoRA adapters (JSON)',
					type: SettingsFieldType.TEXTAREA
				}
			]
		},
		...
		{
			title: SETTINGS_SECTION_TITLES.INTEGRATIONS,
			icon: Rocket,
			fields: []
		},
		{
			title: SETTINGS_SECTION_TITLES.MULTI_MODEL,
			icon: Layers,
			fields: [
				{
					key: SETTINGS_KEYS.MULTI_MODEL_ENABLED,
					label: 'Enable multi-model mode',
					type: SettingsFieldType.CHECKBOX
				},
				{
					key: SETTINGS_KEYS.MULTI_MODEL_IDS,
					label: 'Model IDs (comma-separated)',
					type: SettingsFieldType.INPUT
				},
				{
					key: SETTINGS_KEYS.MULTI_MODEL_MODE,
					label: 'Display mode',
					type: SettingsFieldType.SELECT,
					options: [
						{ label: 'Comparison (side-by-side)', value: 'comparison' },
						{ label: 'Parallel (independent threads)', value: 'parallel' }
					]
				}
			]
		},
		{
			...
			fields: [
				...
				{
					key: SETTINGS_KEYS.REASONING_FORMAT,
					label: 'Reasoning format',
					type: SettingsFieldType.SELECT,
					options: [
						{ label: 'Auto (extract thinking)', value: 'auto' },
		...
		},
		{
			...
			fields: [
				...
				{
					key: SETTINGS_KEYS.KB_ENABLED,
					label: 'Enable knowledge base',
					type: SettingsFieldType.CHECKBOX
				},
				{
					key: SETTINGS_KEYS.WORKSPACE_FOLDER,
...
<div class="flex h-full flex-col overflow-hidden md:flex-row">
	<!-- Desktop Sidebar -->
	<div class="hidden h-full w-64 overflow-y-auto border-r border-border/30 p-6 md:block">
		...
		<div class="space-y-6 p-4 md:p-6">
			<div class="grid">
				...
				{:else if currentSection.title === SETTINGS_SECTION_TITLES.PROVIDERS}
					<ChatSettingsProvidersTab />
				{:else if currentSection.title === SETTINGS_SECTION_TITLES.INTEGRATIONS}
					<ChatSettingsIntegrationsTab />
