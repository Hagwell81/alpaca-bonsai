<script lang="ts">
	...
	import { ChatMessage, ChatComparePanel } from '$lib/components/app';
...
>
	...
	{#if allConversationMessages && messages}
		<ChatComparePanel allMessages={allConversationMessages} activeMessages={messages} />
	{/if}
</div>
