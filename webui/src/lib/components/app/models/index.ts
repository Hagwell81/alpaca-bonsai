...
/**
 * **BonsaiModelsPanel** - Bonsai model catalog onboarding panel
 *
 * Lists the prerequisite Bonsai ternary, image, TTS, and STT models from
 * desktop/bonsai-models.js (mirrors bonsai-beach config/bonsai-beach.toml).
 * Shows which model files are missing and offers one-click download for
 * each model or all missing models at once. Intended for the onboarding /
 * models settings tab.
 */
export { default as BonsaiModelsPanel } from './BonsaiModelsPanel.svelte';
