...
export const SYNCABLE_PARAMETERS: SyncableParameter[] = [
	...
	{ key: 'seed', serverKey: 'seed', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'mirostat', serverKey: 'mirostat', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'mirostat_tau', serverKey: 'mirostat_tau', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'mirostat_eta', serverKey: 'mirostat_eta', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'n_keep', serverKey: 'n_keep', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'n_discard', serverKey: 'n_discard', type: SyncableParameterType.NUMBER, canSync: true },
	{
		key: 'ignore_eos',
		serverKey: 'ignore_eos',
		type: SyncableParameterType.BOOLEAN,
		canSync: true
	},
	{ key: 'grammar', serverKey: 'grammar', type: SyncableParameterType.STRING, canSync: true },
	{
		key: 'grammar_lazy',
		serverKey: 'grammar_lazy',
		type: SyncableParameterType.BOOLEAN,
		canSync: true
	},
	{ key: 'stop', serverKey: 'stop', type: SyncableParameterType.STRING, canSync: true },
	{ key: 'logit_bias', serverKey: 'logit_bias', type: SyncableParameterType.STRING, canSync: true },
	{ key: 'n_probs', serverKey: 'n_probs', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'min_keep', serverKey: 'min_keep', type: SyncableParameterType.NUMBER, canSync: true },
	{ key: 'top_n_sigma', serverKey: 'top_n_sigma', type: SyncableParameterType.NUMBER, canSync: true },
	{
		key: 'post_sampling_probs',
		serverKey: 'post_sampling_probs',
		type: SyncableParameterType.BOOLEAN,
		canSync: true
	},
	{ key: 'chat_format', serverKey: 'chat_format', type: SyncableParameterType.STRING, canSync: true }
];
